...
[![Maven Central](https://img.shields.io/badge/version-1.0.2-blue)](https://github.com/rgryta/Compose-Elements/releases)
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("eu.gryta:compose.elements:1.0.2")
        }
    }
}
```
